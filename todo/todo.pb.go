...
func (x *TaskLists) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TaskLists) ProtoMessage() {}

func (x *TaskLists) ProtoReflect() protoreflect.Message {
	mi := &file_todo_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TaskLists.ProtoReflect.Descriptor instead.
func (*TaskLists) Descriptor() ([]byte, []int) {
	return file_todo_proto_rawDescGZIP(), []int{1}
}

func (x *TaskLists) GetTasks() []*Task {
	if x != nil {
		return x.Tasks
	}
	return nil
...
var file_todo_proto_rawDesc = []byte{
	...
	,
}
...
type TasksClient interface {
	List(ctx context.Context, in *Void, opts ...grpc.CallOption) (*TaskLists, error)
...
func (c *tasksClient) List(ctx context.Context, in *Void, opts ...grpc.CallOption) (*TaskLists, error) {
	out := new(TaskLists)
...
type TasksServer interface {
	List(context.Context, *Void) (*TaskLists, error)
...
func (*UnimplementedTasksServer) List(context.Context, *Void) (*TaskLists, error) {
